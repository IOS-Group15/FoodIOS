...
// Moack data model for budget categories
...
class BudgetTrackerViewModel: ObservableObject {
    ...
    init() {
        self.categories = [
            BudgetCategoryMock(name: "Marketing", limit: 1000, actualSpending: 500),
            BudgetCategoryMock(name: "Operations", limit: 2000, actualSpending: 1500)
        ]
